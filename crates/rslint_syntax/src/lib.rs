...
impl rome_rowan::SyntaxKind for JsSyntaxKind {
	...
	fn to_unknown(&self) -> JsSyntaxKind {
		match self {
			...
			| JS_WHILE_STATEMENT
			| JS_WITH_STATEMENT => JS_UNKNOWN_STATEMENT,
			...
			| JS_YIELD_EXPRESSION
			| NEW_TARGET
			| TEMPLATE => JS_UNKNOWN_EXPRESSION,
			...
			| JS_OBJECT_BINDING_PATTERN_SHORTHAND_PROPERTY => JS_UNKNOWN_BINDING_PATTERN,
			...
			| TS_INDEX_SIGNATURE
			| JS_SHORTHAND_PROPERTY_OBJECT_MEMBER => JS_UNKNOWN_MEMBER,
			...
			| JS_STATIC_MEMBER_ASSIGNMENT => JS_UNKNOWN_ASSIGNMENT,
